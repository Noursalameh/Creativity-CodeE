...
const translations = {
    ...
    // tags: ["Guest House", "Pergola Systems", "Heritage Petra"]
    // },
    // project4: {
    ...
    address: "مبنى عبد العزيز للألبسة, الطابق الخامس<br> شارع عبدالله غوشة مجمع بيسان الثريا رقم. 69، عمان، الأردن 90، عمّان، الأردن"
    }
    }
    };
